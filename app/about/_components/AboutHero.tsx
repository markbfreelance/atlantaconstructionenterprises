    ...
    <section className="relative overflow-hidden bg-navy-950 py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
          Building Trust{" "}
          <span className="text-amber-500">Since 1998</span>
        </h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-navy-300 sm:text-lg">
          Atlanta Construction Enterprises, Inc. was incorporated on January 12,
          1998. For over 25 years we&apos;ve served the greater Atlanta area
          with quality residential and commercial construction, earning the
          trust of homeowners and businesses alike.
        </p>
