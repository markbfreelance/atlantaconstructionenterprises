    ...
    <section className="relative overflow-hidden bg-navy-950 py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
          Comprehensive{" "}
          <span className="text-amber-500">Construction Services</span>
        </h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-navy-300 sm:text-lg">
          From small home repairs to large-scale commercial projects, Atlanta
          Construction Enterprises offers a full range of construction services
          to meet your needs.
        </p>
